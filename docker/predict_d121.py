...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/opt/densenet/models/model.pth', help='Model file')
    parser.add_argument('--image_size', type=int, default=1536, help='Image size')
    parser.add_argument('--crop_size', type=int, default=1024, help='Crop size')
    parser.add_argument('--suffix', type=str, default='jpg', help='Image suffix')
