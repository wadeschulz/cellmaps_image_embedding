...
# -*- coding: utf-8 -*-
#
# cellmaps_image_embedding documentation build configuration file, created by
...
project = u'cellmaps_image_embedding'
...
init_file = os.path.join('..', 'cellmaps_image_embedding', '__init__.py')
...
htmlhelp_basename = 'cellmaps_image_embeddingdoc'
...
latex_documents = [
    (master_doc, 'cellmaps_image_embedding.tex',
     u'cellmaps_image_embedding Documentation',
...
man_pages = [
    (master_doc, 'cellmaps_image_embedding',
     u'cellmaps_image_embedding Documentation',
     [author], 1)
]
